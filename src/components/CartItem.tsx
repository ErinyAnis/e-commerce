    ...
    <div className="w-full grid grid-cols-5 mb-4 border py-2">
      <div className="flex col-span-5 md:col-span-2 items-center gap-4 ml-4">
        <ImCross
          ...
          className="text-accent hover:text-lightRed cursor-pointer hoverEffect"
        />
      ...
      <div className="col-span-5 md:col-span-3 flex items-center justify-between py-4 md:py-0 px-4 lg:px-0">
        ...
        <div className="w-1/3 flex items-center gap-6 text-lg">
          <button
            onClick={handleMinus}
            className="w-6 h-6 bg-gray-100 text-sm flex items-center justify-center hover:bg-darkOrange/10 border-[1px] border-gray-300 hover:border-darkOrange hoverEffect"
          >
            <FaMinus />
          </button>
